...
export function PrivacyContent() {
  return (
    <section className="policy-page">
      ...
      <p>
        This policy explains what information Know Your IT Hub collects, how it is used, and the choices you
...
export function TermsContent() {
  return (
    <section className="policy-page">
      ...
      <p>
        Know Your IT Hub is a community-maintained company directory for job seekers and researchers. It is not
