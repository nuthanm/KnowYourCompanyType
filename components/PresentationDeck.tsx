    ...
    <div className="pres-root">
      ...
      <div className="pres-shell">
        <header className="pres-header">
          <Link href="/" className="pres-logo" aria-label="Know Your IT Hub home — back to landing page">
            <BrandMark />
          </Link>
      ...
      <footer className="pres-footer">
        ...
        {slide < SLIDE_COUNT - 1 ? (
          ...
          <Link href="/companies" className="pres-cta pres-cta-glow">Browse companies →</Link>
            <a href="mailto:inbox.nuthan@gmail.com?subject=Know%20Your%20IT%20Hub%20-%20Approved%20to%20Proceed" className="pres-cta pres-cta-secondary">Approve →</a>
          </div>
        )}
      </footer>
    </div>
...
function SlideCompetitors() {
  const rows = [
    ["Know Your IT Hub (planned)", "Product/service filter", "Full profiles", "Interview intel", "India-first", "Free MVP"],
    ...
    <div className="pres-stagger">
      ...
      <div className="pres-table-wrap mt-6">
        <table className="pres-table">
          ...
          <tbody>
            {rows.map(([name, ...rest]) => (
              <tr key={name} className={name.startsWith("Know Your IT Hub") ? "highlight" : undefined}>
...
function SlideCompare() {
  return (
    <div className="pres-stagger">
      ...
      <h2 className="pres-title mt-4">Where Know Your IT Hub wins</h2>
        ...
        {COVERAGE_COMPARISON.map((row) => (
          <div key={row.label} className="pres-card">
            <div className="mb-2 flex items-center justify-between gap-2">
              ...
              <span className="pres-pill pres-pill-profit text-[10px]">Know Your IT Hub</span>
            </div>
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                <span className="w-28 shrink-0 text-[11px] font-semibold text-[var(--profit)]">Know Your IT Hub</span>
...
function SlideDifferentiation() {
  return (
    <div className="pres-stagger">
      ...
      <h2 className="pres-title mt-4">How Know Your IT Hub is different — and why it&apos;s strong</h2>
      <div className="mt-6 space-y-3">
            ...
            <div className="flex flex-wrap items-start gap-3">
              ...
              <div className="flex-1 min-w-[12rem]">
                ...
                <p className="mt-1 text-[12px]">
                  <span className="font-bold text-[var(--gold)]">Know Your IT Hub: </span>{m.ours}
                </p>
              </div>
            </div>
          </div>
...
function SlideJobSeekerValue() {
  ...
  return (
    <div className="pres-stagger">
      ...
      <p className="pres-subtitle">
        Know Your IT Hub is not Glassdoor or a job board. It is the step before those — a verified snapshot
        ...
        <table className="pres-table">
          <thead>
            <tr>
              ...
              <th>Know Your IT Hub answers with…</th>
            </tr>
          </thead>
          <tbody>
...
function SlideVerification() {
  const steps = [
    ...
    ["4 · Verified stamp", "Only then the profile goes live with the Know Your IT Hub Verified badge — browse with confidence."],
  ];
...
function SlideProductVision() {
  return (
    <div className="pres-stagger">
      ...
      <h2 className="pres-title mt-4">What Know Your IT Hub looks like at launch</h2>
      <div className="pres-mock-app pres-mock-glow mt-6">
        <div className="pres-mock-bar">
          <span>Know Your IT Hub · Company Directory</span>
    ...
    <div className="pres-stagger text-center">
      ...
      <div className="pres-scorecard mt-8 text-left">
        <div className="pres-scorecard-head">
          ...
          <span>Naukri</span>
          <span className="text-[var(--profit)]">Know Your IT Hub</span>
        </div>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        ...
        <a href="mailto:inbox.nuthan@gmail.com?subject=Know%20Your%20IT%20Hub%20MVP%20-%20Approved" className="pres-cta pres-cta-secondary inline-flex">
          Green-light MVP →
        </a>
      </div>
    </div>
